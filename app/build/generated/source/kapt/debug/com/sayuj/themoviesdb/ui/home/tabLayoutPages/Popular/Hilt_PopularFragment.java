...
public abstract class Hilt_PopularFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PopularFragment() {
    super();
  }

  Hilt_PopularFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PopularFragment_GeneratedInjector) this.generatedComponent()).injectPopularFragment(UnsafeCasts.<PopularFragment>unsafeCast(this));
    }
  }
