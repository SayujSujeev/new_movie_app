...
public abstract class Hilt_NowPlayingFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NowPlayingFragment() {
    super();
  }

  Hilt_NowPlayingFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NowPlayingFragment_GeneratedInjector) this.generatedComponent()).injectNowPlayingFragment(UnsafeCasts.<NowPlayingFragment>unsafeCast(this));
    }
  }
