...
public final class FragmentPopularBinding implements ViewBinding {
  ...
  private FragmentPopularBinding(@NonNull FrameLayout rootView, @NonNull ProgressBar progressBar,
  ...
  public static FragmentPopularBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPopularBinding((FrameLayout) rootView, progressBar, recyclerView,
