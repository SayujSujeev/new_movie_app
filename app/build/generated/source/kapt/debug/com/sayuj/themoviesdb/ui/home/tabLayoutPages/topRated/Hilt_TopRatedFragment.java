...
public abstract class Hilt_TopRatedFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TopRatedFragment() {
    super();
  }

  Hilt_TopRatedFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TopRatedFragment_GeneratedInjector) this.generatedComponent()).injectTopRatedFragment(UnsafeCasts.<TopRatedFragment>unsafeCast(this));
    }
  }
