...
public abstract class Hilt_UpComingFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_UpComingFragment() {
    super();
  }

  Hilt_UpComingFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UpComingFragment_GeneratedInjector) this.generatedComponent()).injectUpComingFragment(UnsafeCasts.<UpComingFragment>unsafeCast(this));
    }
  }
